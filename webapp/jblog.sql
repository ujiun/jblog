...
SET DEFINE OFF;
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (3,'ujiun','유지은','123',to_date('22/07/06','RR/MM/DD'));
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (6,'테스트id','테스트userName','테스트paaaword',to_date('22/07/06','RR/MM/DD'));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "JBLOG"."POST" MODIFY ("POSTTITE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "JBLOG"."COMMENTS" ADD CONSTRAINT "COMMENTS_FK_PN" FOREIGN KEY ("POSTNO")
	  REFERENCES "JBLOG"."POST" ("POSTNO") ENABLE;
  ALTER TABLE "JBLOG"."COMMENTS" ADD CONSTRAINT "COMMENTS_FK_UN" FOREIGN KEY ("USERNO")
